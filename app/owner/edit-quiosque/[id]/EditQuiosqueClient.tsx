...
export default function EditQuiosqueClient({ quiosque, isPremium }: Props) {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      <div className="border-b border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800">
        <div className="mx-auto flex h-16 max-w-3xl items-center gap-4 px-4">
          <Link href="/owner/dashboard" className="text-slate-500 hover:text-slate-700">
            <ArrowLeft className="h-5 w-5" />
          </Link>
          <Waves className="h-6 w-6 text-cyan-500" />
          <span className="font-semibold text-slate-900 dark:text-white">Editar Quiosque</span>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <form onSubmit={handleSave} className="space-y-6">
          ...
          {isPremium ? (
            ...
            <div className="rounded-xl border-2 border-dashed border-amber-300 bg-amber-50 p-8 text-center dark:border-amber-700 dark:bg-amber-900/20">
              <Lock className="mx-auto mb-3 h-8 w-8 text-amber-500" />
              <h3 className="text-lg font-semibold text-slate-800 dark:text-white">
                Recursos Premium bloqueados
              </h3>
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                Fotos, contato, serviços e especialidades estão disponíveis apenas no plano Premium.
              </p>
              <a
                href="https://pay.quiosquepraia.com"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-flex items-center gap-2 rounded-lg bg-amber-500 px-4 py-2 text-sm font-medium text-white transition hover:bg-amber-600"
              >
                Assinar Premium
              </a>
            </div>
