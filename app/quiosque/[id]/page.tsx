...
import { extractIdFromSlug, getProxyImageUrl } from '@/lib/utils'
...
async function getQuiosque(slug: string): Promise<Quiosque | null> {
...
export async function generateMetadata({
  ...
  const quiosque = await getQuiosque(id)
